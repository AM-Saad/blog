...
function displayConfirmNotification() {
  if ('serviceWorker' in navigator) {
    var options = {
      ...
      icon: '/shop/images/icons/96.png',
      image: '/shop/images/icons/96.png',
      dir: 'ltr',
      lang: 'en-US', // BCP 47,
      vibrate: [100, 50, 200],
      badge: '/shop/images/icons/96.png',
      tag: 'confirm-notification',
      renotify: true,
      actions: [
        { action: 'confirm', title: 'Okay', icon: '/shop/images/icons/96.png' },
        { action: 'cancel', title: 'Cancel', icon: '/shop/images/icons/96.png' }
      ]
    };
...
function configurePushSub() {
  ...
  navigator.serviceWorker.ready
    ...
    .then(function (newSub) {
      console.log(newSub);
      return fetch('https://abdelrahman-saad.cc//subscribe', {
        method: 'POST',
        headers: {
